...
public class Main extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        int no = Integer.parseInt(jTextField1.getText());
        Dugum yeni = A.agacAra(no);
        if (yeni != null) {
            jLabel3.setText(String.valueOf(yeni.isim));
        }else{
            jLabel3.setText("Aranan değer bulunamadı.");
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(s){
        jLabel3.setText("Silme başarılı");
        }else{
        jLabel3.setText("Silme başarısız");
        }

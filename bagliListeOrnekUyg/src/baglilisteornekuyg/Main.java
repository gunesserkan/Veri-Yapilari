...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton5.setText("Sondan Listele");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Celeman eleman = new Celeman(sayi);
        list.basaEkle(eleman);
        jLabel2.setText(list.listele());
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        int sayi = Integer.parseInt(jTextField1.getText());
        Celeman eleman = new Celeman(sayi);
        list.sonaEkle(eleman);
        jLabel2.setText(list.listele());
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        jLabel2.setText(list.sondanListele());
    }//GEN-LAST:event_jButton5ActionPerformed

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        int sayi = Integer.parseInt(jTextField1.getText());
        Celeman eleman = new Celeman(sayi);
        list.siraliEkle(eleman);
        jLabel2.setText(list.listele());
